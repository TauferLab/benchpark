...
class Ior(AutotoolsPackage):
    ...
    version("cali", git="https://github.com/TauferLab/ior.git", branch="cali_annotations")
    ...
    variant("caliper", default=False, description="support Caliper performance monitoring")
